            ...
            <div>
                <section className={styles['page-header']}>
                    <h1 className={styles['project-name']}>
                        React Image Lightbox Wrapper
                    </h1>

                    <h2 className={styles['project-tagline']}>
                        Wrapper for
                        <a href="https://github.com/fritz-c/react-image-lightbox" target="_blank">
                ...
                <section className={styles['main-content']}>
                    ...
                    <footer className={styles['site-footer']}>
                        <span className={styles['site-footer-owner']}>
                            <a href="https://github.com/fritz-c/react-image-lightbox">React Image Lightbox</a> is maintained by <a
                        ...
                        <span className={styles['site-footer-credits']}>
                            This page was generated by <a href="https://pages.github.com">GitHub Pages</a> using the <a
